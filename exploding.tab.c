...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EXTRACT = 4,                    /* EXTRACT  */
  YYSYMBOL_DONE = 5,                       /* DONE  */
  YYSYMBOL_CHOOSE = 6,                     /* CHOOSE  */
  YYSYMBOL_PLAY = 7,                       /* PLAY  */
  YYSYMBOL_PAIR = 8,                       /* PAIR  */
  YYSYMBOL_GIVE = 9,                       /* GIVE  */
  YYSYMBOL_DEFUSE = 10,                    /* DEFUSE  */
  YYSYMBOL_ATTACK = 11,                    /* ATTACK  */
  YYSYMBOL_SKIP = 12,                      /* SKIP  */
  YYSYMBOL_FAVOR = 13,                     /* FAVOR  */
  YYSYMBOL_SHUFFLE = 14,                   /* SHUFFLE  */
  YYSYMBOL_SEE_FUTURE = 15,                /* SEE_FUTURE  */
  YYSYMBOL_TACO_CAT = 16,                  /* TACO_CAT  */
  YYSYMBOL_POTATO_CAT = 17,                /* POTATO_CAT  */
  YYSYMBOL_RAINBOW_CAT = 18,               /* RAINBOW_CAT  */
  YYSYMBOL_BEARD_CAT = 19,                 /* BEARD_CAT  */
  YYSYMBOL_CATTERMELON = 20,               /* CATTERMELON  */
  YYSYMBOL_TOP = 21,                       /* TOP  */
  YYSYMBOL_MIDDLE = 22,                    /* MIDDLE  */
  YYSYMBOL_BOTTOM = 23,                    /* BOTTOM  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "START", "EXTRACT",
  "DONE", "CHOOSE", "PLAY", "PAIR", "GIVE", "DEFUSE", "ATTACK", "SKIP",
